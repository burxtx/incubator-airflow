...
class MsSqlCheckOperator(CheckOperator):
    """
    Performs checks against Presto. The ``MsSqlCheckOperator`` expects
...
class MsSqlValueCheckOperator(ValueCheckOperator):
    """
    ...
    def __init__(
            ...
            mssql_conn_id='mssql_default',
            *args, **kwargs):
        super(MsSqlValueCheckOperator, self).__init__(
...
class MsSqlIntervalCheckOperator(IntervalCheckOperator):
    """
    ...
    def __init__(
            ...
            mssql_conn_id='mssql_default',
            *args, **kwargs):
        super(MsSqlIntervalCheckOperator, self).__init__(
